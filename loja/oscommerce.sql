...
INSERT INTO categories_description VALUES ( '4', '1', 'Placas de Vídeos');
...
INSERT INTO categories_description VALUES ( '10', '1', 'Ação');
INSERT INTO categories_description VALUES ( '11', '1', 'Ficção Científica');
INSERT INTO categories_description VALUES ( '12', '1', 'Comédia');
...
INSERT INTO categories_description VALUES ( '18', '1', 'Simulação');
INSERT INTO categories_description VALUES ( '19', '1', 'Ação');
INSERT INTO categories_description VALUES ( '20', '1', 'Estratégia');
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Proprietário da Loja', 'STORE_OWNER', 'Harald Ponce de Leon', 'Nome do Proprietário da Loja', '1', '2', now());
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('E-Mail do Proprietário', 'STORE_OWNER_EMAIL_ADDRESS', 'root@localhost', 'E-mail do proprietário da loja', '1', '3', now());
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, use_function, set_function, date_added) VALUES ('País', 'STORE_COUNTRY', '30', 'Minha loja está localizada no país <br><br><b>Observação: Lembre-se de atualizar o Estado da loja.</b>', '1', '6', 'tep_get_country_name', 'tep_cfg_pull_down_country_list(', now());
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, use_function, set_function, date_added) VALUES ('Estado', 'STORE_ZONE', '', 'Estado onde a loja está localizada', '1', '7', 'tep_cfg_get_zone_name', 'tep_cfg_pull_down_zone_list(', now());
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Ordem dos produtos', 'EXPECTED_PRODUCTS_SORT', 'desc', 'Esta é a ordem usada na caixa de seleção dos produtos.', '1', '8', 'tep_cfg_select_option(array(\'asc\', \'desc\'), ', now());
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Como aparecerá a ordem dos produtos', 'EXPECTED_PRODUCTS_FIELD', 'date_expected', 'A ordem dos produtos que são mostrados.', '1', '9', 'tep_cfg_select_option(array(\'products_name\', \'date_expected\'), ', now());
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Trocar a moeda corrente do idioma para padrão', 'USE_DEFAULT_LANGUAGE_CURRENCY', 'false', 'Mudar automaticamente para a moeda corrente padrão do idioma quando for mudado', '1', '10', 'tep_cfg_select_option(array(\'true\', \'false\'), ', now());
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Mostrar produtos comprados', 'DISPLAY_CART', 'true', 'Mostrar o carrinho de compras após a adição de um produto (ou voltar ao início)', '1', '14', 'tep_cfg_select_option(array(\'true\', \'false\'), ', now());
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Enviar página para um amigo', 'ALLOW_GUEST_TO_TELL_A_FRIEND', 'false', 'Permitir que o visitante envie informações da loja e produtos para amigo', '1', '15', 'tep_cfg_select_option(array(\'true\', \'false\'), ', now());
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Usar o método de busca padrão', 'ADVANCED_SEARCH_DEFAULT_OPERATOR', 'and', 'Método de busca padrão', '1', '17', 'tep_cfg_select_option(array(\'and\', \'or\'), ', now());
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Endereço e Telefone da loja', 'STORE_NAME_ADDRESS', 'Nome da loja\nEndereço\nPaís\nTelefone', 'Isto é o Nome de Loja, Endereço e Telefona para ser usado em documentos imprimíveis e exibidos online', '1', '18', 'tep_cfg_textarea(', now());
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Mostrar Quantidades nas categorias', 'SHOW_COUNTS', 'true', 'Mostra quantos produtos estão em cada categoria', '1', '19', 'tep_cfg_select_option(array(\'true\', \'false\'), ', now());
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Mostrar preços com taxas', 'DISPLAY_PRICE_WITH_TAX', 'false', 'Mostrar os preços com o imposto incluído (true) ou mostre o valor do imposto ao lado do preço (false) ', '1', '21', 'tep_cfg_select_option(array(\'true\', \'false\'), ', now());

INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Primeiro nome', 'ENTRY_FIRST_NAME_MIN_LENGTH', '2', 'Quantidade mínima de letras para o primeiro nome', '2', '1', now());
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Sobrenome', 'ENTRY_LAST_NAME_MIN_LENGTH', '2', 'Quantidade mínima de letras para o sobrenome', '2', '2', now());
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Data de Nascimento', 'ENTRY_DOB_MIN_LENGTH', '10', 'Quantidade mínima de letras para a data', '2', '3', now());
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('E-Mail', 'ENTRY_EMAIL_ADDRESS_MIN_LENGTH', '6', 'Quantidade mínima de letras para o e-mail', '2', '4', now());
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Endereço', 'ENTRY_STREET_ADDRESS_MIN_LENGTH', '5', 'Quantidade mínima de letras para o endereço', '2', '5', now());
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Empresa', 'ENTRY_COMPANY_MIN_LENGTH', '2', 'Quantidade mínima de letras para o nome da Empresa', '2', '6', now());
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('CEP', 'ENTRY_POSTCODE_MIN_LENGTH', '4', 'Quantidade mínima de letras para o CEP', '2', '7', now());
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Cidade', 'ENTRY_CITY_MIN_LENGTH', '3', 'Quantidade mínima de letras para a Cidade', '2', '8', now());
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Estado', 'ENTRY_STATE_MIN_LENGTH', '2', 'Quantidade mínima de letras para o estado', '2', '9', now());
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Telefone', 'ENTRY_TELEPHONE_MIN_LENGTH', '3', 'Quantidade mínima de números para o telefone', '2', '10', now());
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Senha', 'ENTRY_PASSWORD_MIN_LENGTH', '5', 'Quantidade mínima de letras para a senha', '2', '11', now());
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Nome do Titular do Cartão', 'CC_OWNER_MIN_LENGTH', '3', 'Quantidade mínima de letras do nome do titular do cartão', '2', '12', now());
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Número do cartão de Crédito', 'CC_NUMBER_MIN_LENGTH', '10', 'Quantidade mínima de números para o cartão de crédito', '2', '13', now());
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Comentários', 'REVIEW_TEXT_MIN_LENGTH', '50', 'Quantidade mínima de letras em um comentário', '2', '14', now());
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Mais Vendidos', 'MIN_DISPLAY_BESTSELLERS', '1', 'Número mínimo de mais vendidos para exibição', '2', '15', now());
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Também Compraram', 'MIN_DISPLAY_ALSO_PURCHASED', '1', 'Número mínimo de produtos para exibição em \'Clientes também Compraram\' box', '2', '16', now());

INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Livro de Endereços', 'MAX_ADDRESS_BOOK_ENTRIES', '5', 'Número máximo de endereços de entrega que um cliente pode ter', '3', '1', now());
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Resultado da Busca', 'MAX_DISPLAY_SEARCH_RESULTS', '20', 'Número máximo de produtos a serem listados', '3', '2', now());
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Links', 'MAX_DISPLAY_PAGE_LINKS', '5', 'Número máximo de links em uma página', '3', '3', now());
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Ofertas', 'MAX_DISPLAY_SPECIAL_PRODUCTS', '9', 'Número máximo de ofertas a serem exibidas', '3', '4', now());
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Novidades', 'MAX_DISPLAY_NEW_PRODUCTS', '9', 'Número máximo de novos produtos a serem exibidos em uma categoria', '3', '5', now());
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Lançamentos', 'MAX_DISPLAY_UPCOMING_PRODUCTS', '10', 'Números máximo de lançamentos a serem exibidos', '3', '6', now());
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Lista de Fabricantes', 'MAX_DISPLAY_MANUFACTURERS_IN_A_LIST', '0', 'Usado no box dos fabricantes; quando o número de fabricantes exceder este número o menu passará a ser de seleção', '3', '7', now());
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Tamanho da Caixa de seleção de fabricantes', 'MAX_MANUFACTURERS_LIST', '1', 'Usado no box dos fabricantes; Quando o valor é \'1\' o drop-down list clássico é usado, do contrário, uma lista com o número definido de linhas será exibida.', '3', '7', now());
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Tamanho máximo do nome do Fabricante', 'MAX_DISPLAY_MANUFACTURER_NAME_LEN', '15', 'Usado no box dos fabricantes; número  máximo de letras do nome do fabricante a ser exibido', '3', '8', now());
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Novos Comentários', 'MAX_DISPLAY_NEW_REVIEWS', '6', 'Número máximo de novos comentários a serem exibidos', '3', '9', now());
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Seleção Randômica de comentários', 'MAX_RANDOM_SELECT_REVIEWS', '10', 'Número de comentários que serão utilizados na seleção', '3', '10', now());
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Seleção Randômica de Novidades', 'MAX_RANDOM_SELECT_NEW', '10', 'Número de comentários que serão utilizados na seleção', '3', '11', now());
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Seleção Randômica de Ofertas', 'MAX_RANDOM_SELECT_SPECIALS', '10', 'Quantos registros serão utilizados para selecionar ofertas a serem exibidas', '3', '12', now());
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Categorias a serem listadas', 'MAX_DISPLAY_CATEGORIES_PER_ROW', '3', 'Número de categorias a serem listadas por fila', '3', '13', now());
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Lista de Novos Produtos', 'MAX_DISPLAY_PRODUCTS_NEW', '10', 'Número máximo de produtos a serem listados na página de novos produtos', '3', '14', now());
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Mais Vendidos', 'MAX_DISPLAY_BESTSELLERS', '10', 'Número máximo de mais vendidos a serem exibidos', '3', '15', now());
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Também compraram', 'MAX_DISPLAY_ALSO_PURCHASED', '6', 'Número máximo de indicações a serem exibidos no box \'Clientes também compraram\' box', '3', '16', now());
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Historico de Pedidos do Cliente', 'MAX_DISPLAY_PRODUCTS_IN_ORDER_HISTORY_BOX', '6', 'Número máximo dos produtos a mostrar na caixa do histórico de pedidos do cliente', '3', '17', now());
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Histórico de Pedidos', 'MAX_DISPLAY_ORDER_HISTORY', '10', 'Número máximo de pedidos na página do histórico de pedidos', '3', '18', now());
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Quantidade de produtos no carrinho de compras', 'MAX_QTY_IN_CART', '99', 'Número máximo de produtos que podem ser adicionados ao carrinho de compras (0 igual a sem limite)', '3', '19', now());
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Largura da Imagem do Cabeçalho', 'HEADING_IMAGE_WIDTH', '57', 'Em pixels', '4', '3', now());
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Altura da Imagem do Cabeçalho', 'HEADING_IMAGE_HEIGHT', '40', 'Em pixels', '4', '4', now());
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Imagem Obrigatória', 'IMAGE_REQUIRED', 'true', 'Abilitar inserção obrigatória de imagens.', '4', '8', 'tep_cfg_select_option(array(\'true\', \'false\'), ', now());
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Módulos Instalados', 'MODULE_PAYMENT_INSTALLED', 'cc.php;cod.php', 'Lista os arquivos de módulos de pagamento separados por um ponto e virgula. Esta listagem é automática e não pode ser editada. (Examplo: cc.php;cod.php;paypal.php)', '6', '0', now());
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Módulos Instalados', 'MODULE_ORDER_TOTAL_INSTALLED', 'ot_subtotal.php;ot_tax.php;ot_shipping.php;ot_total.php', 'Lista os arquivos de módulos de pagamento separados por um ponto e virgula. Esta listagem é automática e não pode ser editada. (Examplo: ot_subtotal.php;ot_tax.php;ot_shipping.php;ot_total.php)', '6', '0', now());
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Módulos Instalados', 'MODULE_SHIPPING_INSTALLED', 'flat.php', 'Lista os arquivos de módulos de pagamento separados por um ponto e virgula. Esta listagem é automática e não pode ser editada. (Examplo: ups.php;flat.php;item.php)', '6', '0', now());
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, use_function, set_function, date_added) VALUES ('País de Origem', 'SHIPPING_ORIGIN_COUNTRY', '223', 'País de origem (será mostrado nos dados do remetende.)', '7', '1', 'tep_get_country_name', 'tep_cfg_pull_down_country_list(', now());
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('CEP', 'SHIPPING_ORIGIN_ZIP', 'NONE', 'Entre com o código postal (CEP) da sua loja (será mostrado nos dados do remetende.).', '7', '2', now());
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Peso Máximo do Pacote que Você Enviará', 'SHIPPING_MAX_WEIGHT', '50', 'Os correios têm um limite de peso máximo para cada pacote.', '7', '3', now());
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Peso Normal dos Pacotes.', 'SHIPPING_BOX_WEIGHT', '3', 'Qual é o peso da embalagem típica de pacotes pequenos e médios?', '7', '4', now());
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Exibir Imagens do Produto', 'PRODUCT_LIST_IMAGE', '1', 'Você deseja exibir a imagem do produto?', '8', '1', now());
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Exibir Nomes dos Fabricantes','PRODUCT_LIST_MANUFACTURER', '0', 'Você deseja exibir o nome do fabricante do produto?', '8', '2', now());
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Exibir Modelos dos Produtos', 'PRODUCT_LIST_MODEL', '0', 'Você deseja exibir o modelo do produto?', '8', '3', now());
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Exibir Nomes dos Produtos', 'PRODUCT_LIST_NAME', '2', 'Você deseja exibir o nome do produto?', '8', '4', now());
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Exibir Preços dos Produtos', 'PRODUCT_LIST_PRICE', '3', 'Você deseja exibir o preço do produto?', '8', '5', now());
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Exibir Quantidade dos Produtos', 'PRODUCT_LIST_QUANTITY', '0', 'Você deseja exibir a quantidade de produtos?', '8', '6', now());
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Exibir Peso dos Produtos', 'PRODUCT_LIST_WEIGHT', '0', 'Você deseja exibiro peso dos produtos?', '8', '7', now());
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Exibir Coluna Compre Agora', 'PRODUCT_LIST_BUY_NOW', '4', 'Você deseja exibir a coluna "compre agora"?', '8', '8', now());
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Localização dos Botões Anterior/Próximo (1-topo, 2-abaixo, 3-ambos)', 'PREV_NEXT_BAR_LOCATION', '2', 'Localização dos Botões Anterior/Próximo (1-topo, 2-abaixo, 3-ambos)', '8', '10', now());

INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Checar Estoque', 'STOCK_CHECK', 'true', 'Verifica se há estoque suficiente disponível', '9', '1', 'tep_cfg_select_option(array(\'true\', \'false\'), ', now());
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Marcar Produtos Sem Estoque', 'STOCK_MARK_PRODUCT_OUT_OF_STOCK', '***', 'Exibir *** quando o produto não estiver disponível em estoque', '9', '4', now());
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Estoque Baixo', 'STOCK_REORDER_LEVEL', '5', 'Defina a quantidade crítica do seu estoque', '9', '5', now());

INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Analisar o Tempo na Página da Loja', 'STORE_PAGE_PARSE_TIME', 'false', 'Armazene o tempo que leva para analisar uma página', '10', '1', 'tep_cfg_select_option(array(\'true\', \'false\'), ', now());
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Destino do Log', 'STORE_PAGE_PARSE_TIME_LOG', '/var/log/www/tep/page_parse_time.log', 'O diretório e nome do arquivo da página que analisará o tempo do log', '10', '2', now());
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Mostrar Analise do Tempo da Página ', 'DISPLAY_PAGE_PARSE_TIME', 'true', 'Mostrar a página de analise tempo (Deve estar habilitado)', '10', '4', 'tep_cfg_select_option(array(\'true\', \'false\'), ', now());
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Armazene as Informações do Banco de Dados', 'STORE_DB_TRANSACTIONS', 'false', 'Armazene as informações do banco de dados na página de analise do tempo do log (PHP4 somente)', '10', '5', 'tep_cfg_select_option(array(\'true\', \'false\'), ', now());
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Diretório do Cache', 'DIR_FS_CACHE', '/tmp/', 'O diretório onde os arquivos de cache serão armazenados', '11', '2', now());

INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Método de Envio de E-Mail', 'EMAIL_TRANSPORT', 'sendmail', 'Defina se este servidor usa uma conexão de local para enviar emails ou se usa uma conexão de SMTP via TCP/IP. Os servidores que executam em Windows e MacOS deveram mudar esta configuração para SMTP.', '12', '1', 'tep_cfg_select_option(array(\'sendmail\', \'smtp\'),', now());
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('E-Mail Linefeeds', 'EMAIL_LINEFEED', 'LF', 'Defina a seqüência de caractere usada para separar o cabeçalho do email.', '12', '2', 'tep_cfg_select_option(array(\'LF\', \'CRLF\'),', now());
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Verifique Endereços de E-mail por DNS', 'ENTRY_EMAIL_ADDRESS_CHECK', 'false', 'Verifique o endereço de e-mail através do servidor DNS', '12', '4', 'tep_cfg_select_option(array(\'true\', \'false\'), ', now());
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Ativar Download', 'DOWNLOAD_ENABLED', 'false', 'Ativa as funções para downloads de produtos.', '13', '1', 'tep_cfg_select_option(array(\'true\', \'false\'), ', now());
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Tempo de Expiração (em dias)' ,'DOWNLOAD_MAX_DAYS', '7', 'Configurar número de dias antes do link de download expirar. Se for 0 o link não ira expirar.', '13', '3', '', now());
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Número Máximo de Downloads' ,'DOWNLOAD_MAX_COUNT', '5', 'Configurar o número máximo de downloads. ( 0 ) significa sem limites.', '13', '4', '', now());

INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Ativar Compressão GZip', 'GZIP_COMPRESSION', 'false', 'Ativar compressão de HTTP GZip.', '14', '1', 'tep_cfg_select_option(array(\'true\', \'false\'), ', now());
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Nível de Compressão', 'GZIP_LEVEL', '5', 'Use um nível de compressão de 0 até 9 (0 = mínimo, 9 = máximo).', '14', '2', now());

INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Diretório da sessão', 'SESSION_WRITE_DIRECTORY', '/tmp', 'Se as sessões são baseadas em arquivos eles serão armazenados nesse diretório.', '15', '1', now());
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Forçar Uso de Cookies', 'SESSION_FORCE_COOKIE_USE', 'False', 'Quando habilitado força o uso de cookies nas seçãos.', '15', '2', 'tep_cfg_select_option(array(\'True\', \'False\'), ', now());
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Checar Sessão de SSL ID', 'SESSION_CHECK_SSL_SESSION_ID', 'False', 'Valida o SSL_SESSION_ID em todo pedido de página de HTTPS seguro.', '15', '3', 'tep_cfg_select_option(array(\'True\', \'False\'), ', now());
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Checar Identidade do usuário', 'SESSION_CHECK_USER_AGENT', 'False', 'Valida a identidade dos clientes em cada solicitação de página.', '15', '4', 'tep_cfg_select_option(array(\'True\', \'False\'), ', now());
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Checar Endereço de IP', 'SESSION_CHECK_IP_ADDRESS', 'False', 'Valida o endereço IP de clientes  em cada solicitação de página.', '15', '5', 'tep_cfg_select_option(array(\'True\', \'False\'), ', now());
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Previnir Sessões de Spider', 'SESSION_BLOCK_SPIDERS', 'True', 'Previne que Spiders conehcidos iniciem uma sessão.', '15', '6', 'tep_cfg_select_option(array(\'True\', \'False\'), ', now());
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Recriar Sessão', 'SESSION_RECREATE', 'False', 'Recriar a sessão para gerar uma nova sessão de identificação quando o cliente logar ou cria uma conta (necessário PHP >= 4,1).', '15', '7', 'tep_cfg_select_option(array(\'True\', \'False\'), ', now());

INSERT INTO configuration_group VALUES ('1', 'Minha Loja', 'Informações gerais sobre minha loja', '1', '1');
INSERT INTO configuration_group VALUES ('2', 'Valores Mínimos', 'Valores mínimos para as funções / dados', '2', '1');
INSERT INTO configuration_group VALUES ('3', 'Valores Máximos', 'Valores máximos para as funções / dados', '3', '1');
INSERT INTO configuration_group VALUES ('4', 'Imagens', 'Parâmetros das Imagens', '4', '1');
INSERT INTO configuration_group VALUES ('5', 'Detalhes do Cliente', 'Configuração da conta do cliente', '5', '1');
INSERT INTO configuration_group VALUES ('6', 'Opções de Módulos', 'Esconder Configuração', '6', '0');
INSERT INTO configuration_group VALUES ('7', 'Entrega/Pacotes', 'Opções de entrega da sua loja', '7', '1');
INSERT INTO configuration_group VALUES ('8', 'Lista de Produtos', 'Opções de configuração da lista de produtos', '8', '1');
INSERT INTO configuration_group VALUES ('9', 'Estoque', 'Configurações do estoque', '9', '1');
INSERT INTO configuration_group VALUES ('10', 'Login', 'Configurações de login', '10', '1');
INSERT INTO configuration_group VALUES ('11', 'Cache', 'Opções de cache', '11', '1');
INSERT INTO configuration_group VALUES ('12', 'Opções de E-Mail', 'Opções para o envio dos emails', '12', '1');
INSERT INTO configuration_group VALUES ('13', 'Download', 'Opções de Download de produtos', '13', '1');
INSERT INTO configuration_group VALUES ('14', 'Compressão GZip', 'Opções do GZip', '14', '1');
INSERT INTO configuration_group VALUES ('15', 'Sessões', 'Opções de sessões', '15', '1');
...
INSERT INTO languages VALUES (1,'Português','pt-BR','icon.gif','portugues',1);
INSERT INTO languages VALUES (2,'English','en','icon.gif','english',2);
INSERT INTO languages VALUES (3,'Deutsch','de','icon.gif','german',3);
INSERT INTO languages VALUES (4,'Español','es','icon.gif','espanol',4);
...
INSERT INTO products_description VALUES (1,1,'Matrox G200 MMS', 'Agora você já pode adquirir a poderosa placa Matrox, uma das placas mais \r\npoderosas do momento, ela possui o sistema VE (Suporta dois monitores \r\nsimultaneamente), e com ela os seus jogos 3D ganharam mais vida e você tera um \r\notimo desempenho em todos os tipos de trababalho com o sistema Dual Display. <br>\r\n<br>\r\nEspecificações :<br>\r\nModelo: Matrox G200 Quad Multi - Monitor Series ( MMS ) Graphics Controller ( 32 \r\nMB ) <br>\r\nMaior Performance 2D/3D<br>\r\nAlta Qualidade em DVD Playback<br>\r\nArquitetura Gráfica: 256-bit <br>\r\nMemória: 32MB DDR <br>\r\nChip Set: Millennium G200 <br>\r\nPlug and Play <br>\r\n<br>\r\nCaracterísticas Especiais:<br>\r\n-Saida para TV (TV-Out)<br>\r\n-Excelente performance em jogos 3D e 2D<br>\r\n-Sistema VE Dual Edition:<br>\r\nSuporta dois monitores simultaneamente.', 'www.matrox.com/mga/products/g200_mms/home.cfm', 0);
INSERT INTO products_description VALUES (2,1,'Matrox G400 32MB', 'Alta performance Gráfica</b> <br>\r\n<br>\r\nMillennium G400 Series - é extremamente diferente com alta performance gráfica, \r\no chip da Millennium G400 Series tem grande velocidade e alta qualidade das \r\nimagens, junto com uma inigualável versatilidade exibindo todas as imagens 3D, \r\n2D e ainda aplicativos DVD. É a mais poderosa e inovadora ferramenta para PC''s.<br>\r\nA Millennium G400 Series não muda somente o modo como você vê os seus gráficos \r\nmas, revolucionará o modo como você vê o seu computador. <br>\r\n<br>\r\n<b>Especificações:</b> </p>\r\n<ul>\r\n  <li>Nova Matrox G400 256-bit DualBus graphics chip </li>\r\n  <li>Alta performance em 3D, 2D e DVD </li>\r\n  <li>Sistema VE Dual Edition: Suporta dois monitores simultaneamente. </li>\r\n  <li>Saída para DVD e TV </li>\r\n  <li>Qualidade de Cor Vibrante com modelo tridimensional </li>\r\n  <li>UltraSharp DAC of up to 360 MHz </li>\r\n  <li>Processador 3D Rendering Array </li>\r\n  <li>Suporte para 16 ou 32 MB de memória</li>\r\n</ul>', 'www.matrox.com/mga/products/mill_g400/home.htm', 0);
INSERT INTO products_description VALUES (3,1,'Microsoft IntelliMouse Pro', 'O Microsoft IntelliMouse é o mais novo membro da família de produtos de \r\nmouse. A nova esfera posicionada no centro entre os dois botões fornece nova \r\nfuncionalidade no Windows 95, 98,ME,XP, Internet Explorer 6.0 e no conjunto de \r\nprodutos do Office 2003. <br>\r\n<br>\r\nBenefícios<br>\r\nTodos os aplicativos do Office 2003 serão compatíveis com o novo mouse, \r\npermitindo ao usuário a transferência com zoom, rolagem e zoom de dados para o \r\nmouse. <br>\r\nA rolagem no Windows Explorer pode ser feita com o mouse - barras de rolagem \r\nnunca mais! <br>\r\nAcesse rapidamente os vínculos ativos na Web (zoom de dados) e retorne à home \r\npage usando o mouse. Agora, navegar nas páginas Web é tão fácil quanto usar o \r\nWord e o IntelliMouse, rolando com a esfera.</p>', 'www.microsoft.com/hardware/mouse/intellimouse.asp', 0);
INSERT INTO products_description VALUES (4,1,'Assassinos Substitutos', 'Título Original: &quot;The Replacement Killers&quot; <br>\r\n<br>\r\nCódigo Regional: 2 (Japão, Europa, Oriente Médio, África do Sul). <br>\r\nIdioma: Inglês, Alemão. <br>\r\nLegendas: Inglês, Alemão, Espanhol. <br>\r\nAudio: Dolby Surround 5.1. <br>\r\nFormato da Tela: 16:9 Wide-Screen. <br>\r\nDuração: (aprox) 80 minutes. <br>\r\nOutros: Menu interativo, Seleção de capítulos, Legendas (mais idiomas). <br>\r\n<br>\r\nSinopse:O astro dos filmes de John Woo, Chow Yun-Fat faz sua estréia em \r\nHollywood tendo ao seu lado Mira Sorvino (vencedora do Oscar de 1995 como Melhor \r\nAtriz Coadjuvante, em Poderosa Afrodite) em ASSASSINOS SUBSTITUTOS, um frenético \r\ne explosivo suspense de ação do diretor Antoine Fuqua (do video-clip de Coolio &quot;Gangsta''s \r\nParadise&quot;). <br>\r\nApós trair Mr. Wei, o impiedoso chefão do crime que o havia contratado para \r\nvingar a morte do filho, o assassino profissional John Lee (Chow) agora está \r\nfugindo. Contando com a ajuda da bela falsificadora de documentos Meg Coburn (Sorvino), \r\nLee pretende retornar para sua família na China, antes que esta seja vitimada \r\npor causa de sua traição. Mas a armada de Wei de &quot;assassinos substitutos&quot; está \r\nna sua trilha, e agora ele e Meg são os alvos de um impressionante poder de \r\nfogo. <br>\r\nCom os dois lados totalmente armados e determinados a lutar até a morte, um \r\ntiroteio ultra-violento explode quando finalmente os dois grupos se encontram. É \r\n&quot;uma fusão nunca antes vista do estilo com a ação e a aventura dos filmes de \r\nHong Kong&quot; (The New York Times) que vai deixar todos sem fôlego - incluindo \r\nvocê!</p>', 'www.replacement-killers.com', 0);
INSERT INTO products_description VALUES (5,1,'Busca Frenética', 'Título Original: &quot;Frantic&quot; <br>\r\n<br>\r\nCódigo Regional: 2 (Japão, Europa, Oriente Médio, África do Sul). <br>\r\nIdioma: Inglês, Alemão. <br>\r\nLegendas: Inglês, Alemão, Espanhol. <br>\r\nAudio: Dolby Surround 5.1. <br>\r\nFormato da Tela: 16:9 Wide-Screen. <br>\r\nDuração: (aprox) 115 minutes. <br>\r\nOutros: Menu interativo, Seleção de capítulos, Legendas (mais idiomas). <br>\r\n<br>\r\nSinopse: Harrison Ford é o Dr. Richard Walker, famoso médico que junto com sua \r\nesposa Sondra (Betty Buckley), visitam Paris pela segunda vez. <br>\r\nPela primeira vez, viveram uma lua-de-mel inesquecível. Agora eles vão viver \r\nmomentos de suspense e terror. Tudo começa quando Sondra desaparece \r\nmisteriosamente do hotel e Walker se vê sozinho em uma terra estranha, sem \r\npistas e sem ninguém. Até que surge a linda Michelle (Eammanuelle Seigner) que \r\nresolve ajudá-lo e o leva à aterradora realidade do submundo de uma busca \r\nincansável por sua esposa. <br>\r\nDirigido pelo aclamado Roman Polanski, BUSCA FRENÉTICA é um thriller de ação e \r\nsuspense de tirar o fôlego. Prepare-se para muita adrenalina.</p>', 'www.bladerunner.com', 0);
INSERT INTO products_description VALUES (6,1,'Matrix', 'Título Original: "The Matrix" <br>\r\n<br>\r\nCódigo Regional: 2 (Japão, Europa, Oriente Médio, África do Sul). <br>\r\nIdioma: Inglês, Alemão. <br>\r\nLegendas: Inglês, Alemão, Espanhol. <br>\r\nAudio: Dolby Surround 5.1. <br>\r\nFormato da Tela: 16:9 Wide-Screen. <br>\r\nDuração: (aprox) 131 minutes. <br>\r\nOutros: Menu interativo, Seleção de capítulos, Making Of. <br><br>\r\nSinopse: <br><br>\r\nO que vemos: Nosso dia a dia é verdadeiro. <br>\r\nO que é real: O mundo é uma farsa, construído por uma das mais poderosas \r\nmáquinas com inteligência artificial para nos controlar. <br>\r\nProezas de tirar o fôlego. Efeitos alucinantes. Cenas de arrebentar. Keanu \r\nReeves e Laurence Fishburne lutam pela libertação da humanidade em Matrix, um \r\nsuspense cibernético para ver e rever muitas vezes, escrito e dirigido pelos \r\nIrmãos Wachowski (Ligadas pelo Desejo). Uma surpreendente história, com efeitos \r\nvisuais alucinantes, marcando uma nova era no cinema. Um filme arrasador.</p>', 'www.thematrix.com', 0);
INSERT INTO products_description VALUES (7,1,'Mensagem para você', 'Título Original: &quot;You''ve Got Mail&quot; <br>\r\n<br>\r\nCódigo Regional: 2 (Japão, Europa, Oriente Médio, África do Sul). <br>\r\nIdioma: Inglês, Alemão, Espanhol. <br>\r\nLegendas: Inglês, Alemão, Espanhol, Francês, Nórdico, Polonês. <br>\r\nAudio: Dolby Surround 5.1. <br>\r\nFormato da Tela: 16:9 Wide-Screen. <br>\r\nDuração: (aprox) 115 minutes. <br>\r\nOutros: Menu interativo, Seleção de capítulos, Legendas (mais idiomas). <br>\r\n<br>\r\nSinopse: MENSAGEM PARA VOCÊ confirma todo romance, charme e emoção que as \r\npessoas poderiam esperar do reencontro das estrelas Tom Hanks e Meg Ryan e da \r\ndiretora Nora Ephron de Sintonia de Amor. Greg Kinnear, Parker Posey, Jean \r\nStapleton e outros coadjuvantes são os ingredientes perfeitos adicionados a este \r\nromance moderno em que o proprietário magnata de uma super-loja de livros e a \r\ndona de uma aconchegante livraria infantil são correspondentes anônimos por \r\ne-mail que se apaixonam perdidamente sem saber que são, na verdade, rivais nos \r\nnegócios</p>', 'www.youvegotmail.com', 0);
INSERT INTO products_description VALUES (8,1,'Vida de Inseto', 'Título Original: &quot;A Bug''s Life&quot; <br>\r\n<br>\r\nCódigo Regional: 2 (Japão, Europa, Oriente Médio, África do Sul). <br>\r\nIdioma: Inglês, Alemão. <br>\r\nLegendas: Inglês, Alemão, Espanhol. <br>\r\nAudio: Dolby Surround 5.1. <br>\r\nFormato da Tela: 16:9 Wide-Screen. <br>\r\nDuração: (aprox) 91 minutes. <br>\r\nOutros: Menu interativo, Seleção de capítulos, Legendas (mais idiomas). <br>\r\n<br>\r\nSinopse: Entre numa viagem folha a folha dentro do minúsculo mundo dos insetos, \r\njunto com os mais diferentes, coloridos e divertidos personagens, na animação \r\ncomputadorizada Disney/Pixar VIDA DE INSETO. <br>\r\nFlik é uma formiga cheia de idéias que, em nome dos &quot;insetos oprimidos de todo o \r\nmundo&quot;, precisa contratar guerreiros para defender sua colônia de um faminto \r\nbando de gafanhotos liderado por Hopper. Mas quando descobrem que o exército de \r\ninsetos é na verdade um fracassado grupo de atores de um circo de pulgas, o \r\ncenário está armado para divertidas confusões... com estes improváveis heróis.\r\n<br>\r\nEstrelando um elenco de dubladores sensacionais, VIDA DE INSETO apresenta uma \r\nnova e surpreendente visão de trabalho de equipe e determinação, que revela \r\nnovos detalhes cada vez que você assiste.</p>', 'www.abugslife.com', 0);
INSERT INTO products_description VALUES (9,1,'Força em Alerta', 'Título Original: &quot;Under Siege&quot; <br>\r\n<br>\r\nCódigo Regional: 2 (Japão, Europa, Oriente Médio, África do Sul). <br>\r\nIdioma: Inglês, Alemão. <br>\r\nLegendas: Inglês, Alemão, Espanhol. <br>\r\nAudio: Dolby Surround 5.1. <br>\r\nFormato da Tela: 16:9 Wide-Screen. <br>\r\nDuração: (aprox) 98 minutes. <br>\r\nOutros: Menu interativo, Seleção de capítulos, Legendas (mais idiomas). <br>\r\n<br>\r\nSinopse: O encouraçado USS Missouri prepara-se para a última viagem. A Marinha \r\norganiza uma grande festa. Porém, são surpreendidos com a presença de \r\nterroristas que pretendem roubar o arsenal de armas nucleares do navio e \r\nprovocar a 3a. Guerra Mundial. Com incrível perícia em artes marciais, está a \r\nbordo o cozinheiro Casey Ryback (Steven Seagal, de Nico - Acima da Lei), que \r\nprepara para os terroristas uma receita explosiva. Ele conta com a ajuda da bela \r\ngarota da Playboy Erika Eleniak contra esses bandidos da pesada, que estão sendo \r\nliderados por um ex-agente da CIA (Tommy Lee Jones, de O Cliente) e um oficial \r\nque trai a Marinha (Gary Busey, de Máquina Mortífera).</p>', '', 0);
INSERT INTO products_description VALUES (10,1,'Força em Alerta 2', 'Título Original: &quot;Under Siege 2 - Dark Territory&quot; <br>\r\n<br>\r\nCódigo Regional: 2 (Japão, Europa, Oriente Médio, África do Sul). <br>\r\nIdioma: Inglês, Alemão. <br>\r\nLegendas: Inglês, Alemão, Espanhol. <br>\r\nAudio: Dolby Surround 5.1. <br>\r\nFormato da Tela: 16:9 Wide-Screen. <br>\r\nDuração: (aprox) 98 minutes. <br>\r\nOutros: Menu interativo, Seleção de capítulos, Legendas (mais idiomas). <br>\r\n<br>\r\nSinopse: O maníaco Travis Dane (Eric Bogosian) sequestrou um luxuoso trem de \r\npassageiros e o transformou em um centro de comando de alta tecnologia, capaz de \r\ncontrolar um poderoso satélite americano. Seu plano: destruir a Costa Leste dos \r\nEstados Unidos. Seu alvo: um reator nuclear, localizado nos subterrâneos do \r\nPentágono. Seu preço: um bilhão de dólares. Seu problema: Casey Ryback (Steven \r\nSeagal, de A Força em Alerta) um dos passageiros a bordo do trem. \r\nEx-especialista da marinha, Casey é uma arma letal de combate. <br>\r\nCom o trem se dirigindo a um território selvagem, onde todos os tipos de \r\ncomunicação externa são naturalmente interrompidos, a vida de três milhões de \r\npessoas depende das habilidade mortais de Ryback, que enfrentará sozinho Travis \r\ne seus perigosos terroristas</p>', '', 0);
INSERT INTO products_description VALUES (11,1,'Ameaça Subterrânea', 'Título Original: &quot;Fire Down Below&quot; <br>\r\n<br>\r\nCódigo Regional: 2 (Japão, Europa, Oriente Médio, África do Sul). <br>\r\nIdioma: Inglês, Alemão. <br>\r\nLegendas: Inglês, Alemão, Espanhol. <br>\r\nAudio: Dolby Surround 5.1. <br>\r\nFormato da Tela: 16:9 Wide-Screen. <br>\r\nDuração: (aprox) 104 minutes. <br>\r\nOutros: Menu interativo, Seleção de capítulos, Legendas (mais idiomas). <br>\r\nSinopse: O Agente Federal de proteção ambiental Jack Taggart (Steven Seagal, de \r\nA Força em Alerta) está investigando a morte de um colega. Seguindo as pistas \r\ndeixadas pelo agente assassinado, Jack parte em viagem pelas pequenas \r\ncomunidades ruais do Kentucky. Em pouco tempo, ele descobre que toneladas de \r\nresiduos tóxicos estão sendo despejadas nas antigas minas de carvão da região. \r\nMuitos habitantes locais estão ficando doentes, mas os criminosos estão \r\nprotegidos pelo silêncio de uma cidade dominada pelo medo. Taggart descobre \r\ninformações importantes conta o poderoso minerador Orin Hanner (Kris \r\nKristofferson, de Rodeio da Vida) e decide enfrentá-lo antes que uma catástrofe \r\necológica destrua completamente a região.', '', 0);
INSERT INTO products_description VALUES (12,1,'Duro de Matar', 'Código Regional: 2 (Japão, Europa, Oriente Médio, África do Sul). <br>\r\nIdioma: Inglês, Alemâo. <br>\r\nLegendas: Inglês, Alemão, Espanhol. <br>\r\nAudio: Dolby Surround 5.1. <br>\r\nFormato da Tela: 16:9 Wide-Screen. <br>\r\nDuração: (aprox) 122 minutes. <br>\r\nOutros: Menu Interativo, Seleção de Capítulos, Legendas (Mais idiomas). <br>\r\n<br>\r\nEm Nova York, o terrorista Simon (Jeremy Irons) explode uma bomba dentro de um \r\nshopping lotado. John Mc Lane (Bruce Willis) corre contra o tempo, desvendando \r\ncharadas propostas pelo vilão. <br>\r\nGRAHAM GREENE BRUCE WILLIS SAMUEL L. JACKSON COLLEEN CAMP LARRY BRYGGMAN SAM \r\nPHILLIPS JEREMY IRONS', '', 0);
INSERT INTO products_description VALUES (13,1,'Máquina Mortífera', 'Título Original: &quot;Lethal Weapon&quot; <br>\r\n<br>\r\nCódigo Regional: 2 (Japão, Europa, Oriente Médio, África do Sul). <br>\r\nIdioma: Inglês, Alemão. <br>\r\nLegendas: Inglês, Alemão, Espanhol. <br>\r\nAudio: Dolby Surround 5.1. <br>\r\nFormato da Tela: 16:9 Wide-Screen. <br>\r\nDuração: (aprox) 100 minutes. <br>\r\nOutros: Menu interativo, Seleção de capítulos, Legendas (mais idiomas). <br>\r\n<br>\r\nSinopse:Martin Riggs (Mel Gibson, da famosa série Mad Max) não é um policial \r\ncomum. É um Mad Max que se tornou maníaco, um homem cuja destreza para matar e \r\ntendências suicidas o tranformam numa Máquina Mortífera para qualquer um que \r\nesteja tanto contra como a seu favor. Roger Murtaugh (Danny Glover, de A Cor \r\nPúrpura) é um tranqüilo detetive de homicídios, que ama sua família, tem uma \r\nbela casa, e espera uma boa aposentadoria que não quer perder. Imagine o susto \r\nde Murtaugh quando descobre que seu novo parceiro será alguém que não tenha nada \r\na perder: o desvairado e desprezado Martin Riggs.', '', 0);
INSERT INTO products_description VALUES (14,1,'Justiça Vermelha', 'Título Original: &quot;Red Corner&quot; <br>\r\n<br>\r\nCódigo Regional: 2 (Japão, Europa, Oriente Médio, África do Sul). <br>\r\nIdioma: Inglês, Alemão. <br>\r\nLegendas: Inglês, Alemão, Espanhol. <br>\r\nAudio: Dolby Surround 5.1. <br>\r\nFormato da Tela: 16:9 Wide-Screen. <br>\r\nDuração: (aprox) 117 minutes. <br>\r\nOutros: Menu interativo, Seleção de capítulos, Legendas (mais idiomas). <br>\r\n<br>\r\nSinopse: <br>\r\nNa história, Richard Gere interpreta Jack Moore, um brilhante advogado de um \r\ngrande conglomerado de entretenimento e o melhor negociador que o Ocidente tem \r\npara oferecer. Ele está na China para fechar o primeiro contrato de comunicação \r\nde satélites sancionado pelo governo chinês mas, após uma noite com uma mulher \r\nexótica, se vê envolvido numa trama que põe sua vida em jogo. Preso por um \r\nassassinato que não cometeu e abandonado por seus colegas de trabalho \r\namericanos, Jack precisa encontrar uma saída desse labirinto conhecido como \r\nsistema judicial chinês. Diferente da América, um culpado por ofensa capital na \r\nChina é morto no período de uma semana após a sua sentença e o custo da munição \r\né cobrado à sua família; um julgamento nesse país dura, em média, menos de \r\nquatro horas, e o grau de convicção beira os 99%. <br>\r\nA única chance de Jack é sua advogada de defesa, Shen Yuelin (Bai Ling), \r\napontada pela corte. Imediatamente, ela entra com uma declaração de culpa \r\ninsistindo ser a única forma de salvar a vida de seu cliente - &quot;clemência \r\nàqueles que confessam; severidade àqueles que resistem&quot;. <br>\r\nEla acredita na inocência de Jack e, ao se comprometer em salvá-lo dentro de um \r\nsistema imperdoável, está se comprometendo a sacrificar sua vida. Trabalhando \r\njuntos, apesar das grandes diferenças culturais, os dois começam a descobrir \r\nevidências bizarras do envolvimento de membros do alto escalão do governo.</p>', '', 0);
INSERT INTO products_description VALUES (16,1,'Coragem Sob Fogo', 'Título Original: &quot;Courage Under Fire&quot; <br>\r\n<br>\r\nCódigo Regional: 2 (Japão, Europa, Oriente Médio, África do Sul). <br>\r\nIdioma: Inglês, Alemão. <br>\r\nLegendas: Inglês, Alemão, Espanhol. <br>\r\nAudio: Dolby Surround 5.1. <br>\r\nFormato da Tela: 16:9 Wide-Screen. <br>\r\nDuração: (aprox) 112 minutes. <br>\r\nOutros: Menu interativo, Seleção de capítulos, Legendas (mais idiomas). <br>\r\n<br>\r\nSinopse: <br>\r\n&quot;Em tempo de guerra, a primeira baixa é sempre a verdade.&quot; <br>\r\nJaneiro de 1991. O mundo está assistindo à Guerra do Golfo dia e noite, milhões \r\nde pessoas sintonizam a CNN para ver a vida real e o drama da morte nas cidades \r\ne desertos do Iraque. <br>\r\nComo o Exército americano ocupa um lugar de destaque na trama, o Departamento de \r\nRelações Públicas da Casa Branca está trabalhando além da conta. O que eles \r\nestão procurando é um herói. O que eles encontram é um escândalo. O que um \r\noficial encrencado agora precisa encobrir é a verdade.</p>', '', 0);
INSERT INTO products_description VALUES (17,1,'Velocidade Máxima', 'Título Original: &quot;Speed&quot; <br>\r\n<br>\r\nCódigo Regional: 2 (Japão, Europa, Oriente Médio, África do Sul). <br>\r\nIdioma: Inglês, Alemão. <br>\r\nLegendas: Inglês, Alemão, Espanhol. <br>\r\nAudio: Dolby Surround 5.1. <br>\r\nFormato da Tela: 16:9 Wide-Screen. <br>\r\nDuração: (aprox) 112 minutes. <br>\r\nOutros: Menu interativo, Seleção de capítulos, Legendas (mais idiomas). <br>\r\n<br>\r\nSinopse: Prepare-se para uma sequência de emoções vibrantes, cenas de ação de \r\ntirar o fôlego e um romance inesperado, num filme que você vai querer ver muitas \r\nvezes. Keanu Reeves é Jack Traven, um especialista da equipe SWAT da polícia de \r\nLos Angeles que é enviado para desarmar uma bomba colocada num ônibus por um \r\nmaníaco vingativo (Dennis Hopper). Jack e a passageira Sandra Bullock têm que \r\nmanter o ônibus a mais de 80 km/h ou a bomba explodirá. Uma perseguição cheia de \r\nsuspense, ação e reviravoltas que vai deixar você com os olhos grudados na tela.</p>', '', 0);
INSERT INTO products_description VALUES (18,1,'Velocidade Máxima 2', 'Título Original: &quot;Speed 2: Cruise Control&quot; <br>\r\n<br>\r\nCódigo Regional: 2 (Japão, Europa, Oriente Médio, África do Sul). <br>\r\nIdioma: Inglês, Alemão. <br>\r\nLegendas: Inglês, Alemão, Espanhol. <br>\r\nAudio: Dolby Surround 5.1. <br>\r\nFormato da Tela: 16:9 Wide-Screen. <br>\r\nDuração: (aprox) 120 minutes. <br>\r\nOutros: Menu interativo, Seleção de capítulos, Legendas (mais idiomas). <br>\r\n<br>\r\nSinopse:Agarre-se ao seu salva-vidas quando a super sequência de Velocidade \r\nMáxima atingir o alto-mar. Sandra Bullock revive o papel que a transformou em \r\nestrela como Annie Porter, uma jovem mulher esperando divertir-se em férias no \r\nCaribe ao lado do seu namorado (Jason Patric) a bordo do transatlântico mais \r\nluxuoso do mundo. Mas sua viagem ao paraíso torna-se mortal quando um lunático \r\ngênio de computadores (Willem Dafoe) assume o controle do navio e o coloca numa \r\nrota de destruição. Uma viagem explosiva conduzida pelo audacioso diretor Jan De \r\nBont (Velocidade Máxima, Twister), VELOCIDADE MÁXIMA 2 navega nas ondas \r\nselvagens em velocidade alucinante.</p>', '', 0);
INSERT INTO products_description VALUES (19,1,'Quem vai ficar com Mary?', 'Título Original: &quot;There''s Something About Mary&quot; <br>\r\n<br>\r\nCódigo Regional: 2 (Japão, Europa, Oriente Médio, África do Sul). <br>\r\nIdioma: Inglês, Alemão. <br>\r\nLegendas: Inglês, Alemão, Espanhol. <br>\r\nAudio: Dolby Surround 5.1. <br>\r\nFormato da Tela: 16:9 Wide-Screen. <br>\r\nDuração: (aprox) 114 minutes. <br>\r\nOutros: Menu interativo, Seleção de capítulos, Legendas (mais idiomas). <br>\r\n<br>\r\nSinopse: Uma comédia romântica com muitas gozações sobre a maneira como os \r\njovens se apaixonam e as dificuldades de lidar com o amor... <br>\r\nApaixonado desde os tempos do curso colegial por Mary (Cameron Diaz), o \r\ntrapalhão Ted (Ben Stiller) localiza de novo a gata de seus sonhos treza anos \r\nmais tarde com a ajuda de um investigador particular muito pilantra (Matt Dillon), \r\nque também se apaixona por ela. Para complicar ainda mais as coisas, os dois \r\ndescobrem que qualquer homem que conheça a deslumbrante Mary fica doido para se \r\ncasar com ela. Mais um grande êxito da famosa dupla de diretores, os irmãos \r\nBobby e Peter Farrelly, que já fizeram grande sucesso com Débi &amp; Lóide.</p>', '', 0);
INSERT INTO products_description VALUES (20,1,'Bem Amada', 'Título Original: &quot;Beloved&quot; <br>\r\n<br>\r\nCódigo Regional: 2 (Japão, Europa, Oriente Médio, África do Sul). <br>\r\nIdioma: Inglês, Alemão. <br>\r\nLegendas: Inglês, Alemão, Espanhol. <br>\r\nAudio: Dolby Surround 5.1. <br>\r\nFormato da Tela: 16:9 Wide-Screen. <br>\r\nDuração: (aprox) 164 minutes. <br>\r\nOutros: Menu interativo, Seleção de capítulos, Legendas (mais idiomas). <br>\r\n<br>\r\nSinopse:<br>\r\nBaseado em um romance da vencedora do prêmio Nobel Toni Morrison, Bem Amada (Beloved) \r\né um grande afresco histórico da América do Norte escravagista no fim do século \r\nXIX. A popular apresentadora de TV Oprah Winfrey interpreta a protagonista, \r\nSethe, uma ex-escrava que tenta levar uma vida normal ao lado da voluntariosa \r\nfilha Denver (Kimberly Elise). Atormentada por segredos inconfessáveis de seu \r\npassado, ela encontra no velho amigo Paul D (Danny Glover) um consolo para seu \r\nsofrimento interior. Thandie Newton encarna a personagem que dá nome ao filme. \r\nBeloved é uma presença misteriosa, cuja influência maléfica irá desequilibrar a \r\nexistência de todos à sua volta.</p>', '', 0);
INSERT INTO products_description VALUES (21,1,'SWAT 3: Close Quarters Battle', 'Los Angeles 2005. Representantes de todas as nações do mundo estarão reunidos \r\npara testemunhar a assinatura do Tratado de Desarmamento Nuclear das Nações \r\nUnidas. A proteção desses homens contra os ataques implacáveis de forças \r\nterroristas caberá à SWAT. O destino de muitas vidas está em suas mãos.<br>\r\n<br>\r\nDestaques<br>\r\n<br>\r\nTeste sua coragem em 21 missões intensas - todas em locais reais de Los Angeles. \r\nA vida de pessoas inocentes e a captura dos terroristas dependem de você e de \r\nsua equipe.<br>\r\n<br>\r\nJogue no modo cooperativo ou de combate mortal contra até cinco jogadores, em \r\nrede ou via Internet. Personalize tudo, de armas e skins ao número e tipos de \r\nadversários e reféns.<br>\r\n<br>\r\nColoque à prova sua imaginação. Crie novos níveis ou mude os que já existem. \r\nRecrie conflitos da vida real e rescreva a história da cidade. Instale \r\nmodificações rapidamente usando o MOD Selector.', 'www.swat3.com', 0);
INSERT INTO products_description VALUES (22,1,'Torneio irreal', 'Título Original: &quot;Unreal Tournament&quot; <br>\r\n<br>\r\nO jogo Single player é emoção do começo ao fim, que vai fazer você cerrar os \r\npunhos enquanto os tiros vêm de todos os lados! Comande sua equipe de \r\nguerrilheiros virtuais &quot;bots&quot; contra os mais mortais gladiadores virtuais da \r\ngaláxia e torne-se o Grande Mestre do Unreal. Ação Multiplayer de arrepiar a \r\nespinha. Seja ou não On-line. Arrase com todo mundo, bots ou humanos, em novos \r\nmodos de jogo: Capturar bandeira, Ataque, Dominação e novas variações de \r\nCombates Mortais que não requerem acesso à Internet.<br>\r\n<br>\r\n50 Níveis de batalha, verdadeiras obras de arte. Um galeão, tumbas egípcias, \r\nsubmarinos, trens de alta velocidade, castelos espaciais e muito mais ! Tudo \r\nisso pode ser jogado on-line ou não e nos modos para um ou vários jogadores. \r\nEsses níveis elevam o padrão dos ambientes de ação 3D<br>\r\n<br>\r\nImagens e sons além da realidade. Texturas super detalhadas criam mundos \r\nfantásticos. Suporta as placas 3D de última geração, mas não exige placa 3D.<br>\r\n<br>\r\nArsenal Detonante, totalmente novo e aperfeiçoado, uma garantia de que vai rolar \r\nmuito sangue ! Mais de 10 armas - cada uma com dois modos de tiro - a sua \r\ndisposição.<br>\r\n<br>\r\nTome controle do jogo.Treine no modo novato e use os níveis tutoriais para \r\narrasar em combate. Se você quiser mais velocidade, mais dano, mais intensidade \r\ne mais tudo... tente o modo Hardcore.', 'www.unrealtournament.net', 0);
INSERT INTO products_description VALUES (23,1,'A Roda do Tempo', 'Título Original: &quot;The Wheel Of Time&quot; <br>\r\n<br>\r\nDas páginas dos best-sellers de Robert Jordan para as telas dos PCs, The Wheel \r\nof Time conta a história da busca dos quatro selos mágicos utilizados para \r\naprisionar &quot;O Obscuro&quot;, uma entidade das trevas com poder suficiente para \r\ndestruir o mundo. <br>\r\n<br>\r\nPara recuperar esses selos, você deverá se envolver em uma trama de intrigas e \r\ntraições no papel de Elayna Sedai, Guardiã das Crônicas da Torre Branca. Em The \r\nWheel of Time, você percorrerá 18 níveis de jogo, unidos por belíssimas cenas de \r\nanimação que contam esta fascinante história de aventura épica. A história que \r\nse desenrola, pouco a pouco, à medida que ocorre a ação, tendo como objetivo \r\nrecuperar os selos mágicos roubados da Torre Branca por forças malignas. <br>\r\n<br>\r\nUm Fantástico modo de jogo single palyer, que permite viajar por 15 mundos em \r\numa jornada para encontrar os selos místicos, com a possibilidade de utilizar \r\nmais de 40 magias e artefatos de poder inimaginável, como bolas de fogo, \r\nrelâmpagos, disfarces, levitação, etc. <br>\r\n<br>\r\nVisuais espetaculares criados por uma versão aprimorada do poderoso engine do \r\nUnreal. Chamas iluminam o cenário e gotas de chuva caem, agitando poças de água \r\ncom realismo jamais visto. Ambientes belíssimos e cenários monumentais \r\ninspirados na arte gótica trazem inigualáveis detalhes arquitetônicos, realçados \r\npor incríveis efeitos especiais. <br>\r\n&nbsp;', 'www.wheeloftime.com', 0);
INSERT INTO products_description VALUES (24,1,'A Terra Sagrada', 'Título original: &quot;Disciples: Sacred Lands&quot; <br>\r\n<br>\r\nUma nova era esta nascendo...<br>\r\n<br>\r\nEntre no reino das terras sagradas, onde o nascer da nova era encontra-se nos \r\nmaiores momentos da guerra. Como prevê a profecia, quatro raças confrontam-se \r\ncom espadas e feitiçaria numa perigosa disputa pelo controle do destino dos seus \r\nDeuses. Enfrente a busca como o campeão do Império, clã das montanhas, legião \r\ndos malditos, ou multidão dos mortos-vivos e teste sua fé nas batalhas de força, \r\nenfeitiçando e atuando com malícia matando demônios, vencendo gigantes e \r\ncombatendo sem misericórdia as forças dos mortos e dos mortos-vivos. Mas a \r\nsegurança da salvação do seu Deus deve envolver o herói dentro de você.<br>\r\n&nbsp;', '', 0);
INSERT INTO products_description VALUES (25,1,'Microsoft Internet Keyboard PS/2', '<p>Acesso à Internet com um toque e muito mais! O Internet Keyboard possui dez \r\nteclas de acesso em um design de teclado padrão confortável que também traz um \r\ndescanso para mãos destacável. As teclas de acesso permitem navegar na Web ou \r\nverificar correio eletrônico diretamente de seu teclado. O software IntelliType \r\nPro também permite personalizar suas teclas de acesso – trabalhe com o Internet \r\nKeyboard da maneira que preferir! <br>\r\n<br>\r\nBenefícios <br>\r\nDez teclas de acesso permitem que você tenha maior controle sobre seu PC - \r\nAcesse a Internet, seu correio eletrônico e os programas favoritos diretamente \r\nde seu teclado. <br>\r\nAlta qualidade, alto valor – O Microsoft Internet Keyboard é um teclado de alta \r\nqualidade, feito para durar e tem garantia de 3 anos pela PHPmania. <br>\r\nDescanso para mãos destacável - O confortável descanso para mãos serve de apoio \r\npara os antebraços e pode ser removido para aumentar o espaço na mesa. <br>\r\nExecute tarefas comuns rapidamente como Recortar, Copiar e Colar com a ajuda dos \r\natalhos da tecla Control.</p>', '', 0);
INSERT INTO products_description VALUES (26,1,'Microsoft IntelliMouse Explorer', 'O primeiro avanço realmente importante na tecnologia dos mouses desde a \r\ndécada de 60.<br>\r\nO IntelliMouse com IntelliEye ultrapassou toda a antiga tecnologia mecânica \r\nusada nos mouses atuais. Este mouse usa um novo sensor óptico que rastreia a \r\nsuperfície abaixo do mouse 1.500 vezes por segundo para registrar com precisão e \r\nregularidade os mínimos movimentos. Ele funciona em centenas de superfícies (ou \r\nseja, chega de mouse pad) e permanece "preciso como novo" porque não existem \r\npeças móveis que se desgastam ou retêm sujeira. <br>\r\n<br>\r\nBenefícios<br>\r\n<br>\r\nPrecisão - O sensor óptico preciso do IntelliEye registra os movimentos sobre \r\nqualquer tipo de superfície. O sensor precisa apenas de uma superfície com um \r\npequeno volume de detalhes, o que inclui madeira, plástico ou até o tecido de \r\nsua calça. <br>\r\nNavegação mais fácil na Internet - Os dois botões do polegar atuam com botões de \r\navançar e voltar no seu navegador. <br>\r\nPrecisão - Nada de partes móveis, e portanto seu mouse está sempre suave e \r\npreciso, não sendo necessário usar um mouse pad. <br>\r\nAcomoda-se muito bem à sua mão - Este mouse foi desenvolvido para dar apoio à \r\nsua mão e seus dedos. As laterais emborrachadas facilitam prender o mouse entre \r\nos dedos e o deixam mais confortável de usar, pois ele exige menos esforço para \r\nsegurar. <br>\r\nGarantia - O IntelliMouse Explorer vem com garantia limitada de hardware de 5 \r\nanos pela PHPmania.org.</p>', 'www.microsoft.com/hardware/mouse/explorer.asp', 0);
INSERT INTO products_description VALUES (27,1,'Hewlett Packard LaserJet 1100Xi', 'A Hewlett Packard está sempre na frente na tecnologia de impressão a laser. A nova \r\ngeração HP LaserJet 1100, marca outra série impressionante no ritmo de impressão \r\ne velocidade, sendo de 8 páginas por minuto. Imprimir em uma resolução de 600 \r\ndpi, com tecnologia de resolução avançada (Resolution Enhancement technology - \r\nREt) HP faz todos os documentos mais profissionais, aumentando a velocidade de \r\nimpressão e a qualidade a laser, resultam apenas no começo com 2MB de memória.<br>\r\n<br>\r\nUsuários da HP LaserJet 1100xi serão capazes de imprimir páginas cada vez mais \r\ncomplexas, a memória é expansível para até 18MB, facilitando a impressão de \r\ndocumentos mais complexos. A HP LaserJet 1100xi suporta as plataformas Windows \r\n3.1, 3.11, 95, 98, ME, XP. Compatibilidade de rede através do HP JetDirect \r\nExternal Print Servers.<br>\r\n<br>\r\nHP LaserJet 1100xi também pode criar documentos para a Web Era da Trellix Corp. \r\n(Oferencendo um software que é capaz de criar documentos web).</p>', 'www.pandi.hp.com/pandi-db/prodinfo.main?product=laserjet1100', 0);
...
INSERT INTO products_description VALUES (24,3,'Disciples: Sacred Land','Rundenbasierende Fantasy/RTS-Strategie mit gutem Design (vor allem die Levels, 4 versch. Rassen, tolle Einheiten), fantastischer Atmosphäre und exzellentem Soundtrack. Grafisch leider auf das Niveau von 1990.','www.strategyfirst.com/disciples/welcome.html',0);
INSERT INTO products_description VALUES (25,3,'Microsoft Internet Tastatur PS/2','<i>Microsoft Internet Keyboard,Windows-Tastatur mit 10 zusätzl. Tasten,2 selbst programmierbar, abnehmbareHandgelenkauflage. Treiber im Lieferumfang.</i><br><br>\r\nEin-Klick-Zugriff auf das Internet und vieles mehr! Das Internet Keyboard verfügt über 10 zusätzliche Abkürzungstasten auf einer benutzerfreundlichen Standardtastatur, die darüber hinaus eine abnehmbare Handballenauflage aufweist. Über die Abkürzungstasten können Sie durch das Internet surfen oder direkt von der Tastatur aus auf E-Mails zugreifen. Die IntelliType Pro-Software ermöglicht außerdem das individuelle Belegen der Tasten.','',0);
...
INSERT INTO products_options VALUES (4,1,'Memória');
...
INSERT INTO products_options VALUES (2,3,'Größe');
...
INSERT INTO reviews_description VALUES (1,1, 'Sem dúvida um dos filmes mais engraçados de 1999!');
...
INSERT INTO tax_class VALUES (1, 'Mercadorias Tributáveis', 'The following types of products are included non-food, services, etc', now(), now());
